...
#     response = requests.get('http://localhost:7000/api/accounts/_all?orderBy=date_asc')
#     assert response.status_code == 200
#     response_json = response.json()
...
#     response = requests.get('http://localhost:7000/api/accounts/_all?orderBy=date_desc')
#     assert response.status_code == 200
#     response_json = response.json()
#     dates = [r['date'] for r in response_json['transactions']]
#     assert dates == reversed(sorted(dates))
